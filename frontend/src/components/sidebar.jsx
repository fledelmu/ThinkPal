                ...
                <div className='flex-grow flex flex-col w-full items-center justify-center gap-5 pt-3 pb-3 mt-3'>
                    ...
                    <div className="relative group w-fit h-fit flex justify-center">
                        <div 
                            ...
                            ${currentBtn === 0 || activeTab === "Dashboard" ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
                        ></div>
                        <button
                            className="relative z-10 flex items-center justify-center px-3 py-2"
                            onMouseEnter={() => setCrntBtn(0)}
                            onMouseLeave={() => setCrntBtn(null)}
                            onClick={() => setActive("Dashboard")}
                        >
                            <img
                            src={currentBtn === 0 || activeTab === "Dashboard" ? dashboard_icon_hover : dashboard_icon}
                            className="w-8 h-8"
                            alt="Notes Icon"
                            />
                        </button>
                    ...
                    <div className="relative group w-fit h-fit flex justify-center">
                        ...
                        >
                            <img
                            src={currentBtn === 2 || activeTab === "Quizzes" ? quiz_icon_hover : quiz_icon}
                            className="w-8 h-8"
                            alt="Quiz Icon"
                            />
                        </button>
