...
const Sidebar = ({ setActive, activeTab }) => {
    ...
    return(
        <>
            <div className='fixed top-0 left-0 h-full w-28 flex flex-col justify-items items-center bg-rule-60 text-white text-lg p-3'>
                <div className='p-2'>
                    <img src={Pic} className="w-16 h-auto" alt="Sidebar Logo" />
                </div>
